...
const kTextValidatorPasswordRegex = r'^(?=.*[A-Za-z])(?=.*\d).{8,}$';
// Optional leading '+', 7-15 digits, allowing spaces/dashes/parens as separators.
const kTextValidatorPhoneRegex = r'^\+?[0-9\s\-\(\)]{7,20}$';
