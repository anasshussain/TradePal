  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case ApplicationsRow:
            return ApplicationsRow(data);
          case ConversationParticipantsRow:
            return ConversationParticipantsRow(data);
          case ConversationsRow:
            return ConversationsRow(data);
          case EmailVerificationsRow:
            return EmailVerificationsRow(data);
          case InsurancePoliciesRow:
            return InsurancePoliciesRow(data);
          case JobActivityRow:
            return JobActivityRow(data);
          case JobImagesRow:
            return JobImagesRow(data);
          case JobTradesRow:
            return JobTradesRow(data);
          case JobsRow:
            return JobsRow(data);
          case LocationsRow:
          ...
          case ProposalPaymentsRow:
            return ProposalPaymentsRow(data);
          case PushTokensRow:
            return PushTokensRow(data);
          case ReviewsRow:
          ...
          case TradesRow:
            return TradesRow(data);
          case UserRolesRow:
            return UserRolesRow(data);
          case UserTradesRow:
            return UserTradesRow(data);
          case UsersRow:
