...
import '/viewmodels/button4_model.dart';
export '/viewmodels/button4_model.dart';
...
class Button4Widget extends StatefulWidget {
  const Button4Widget({
    ...
    bool? loading,
    bool? disabled,
    required this.onPressed,          // 👈 ab widget field se link ho gaya
  ...
  final bool loading;
  final bool disabled;
  final Future<void> Function() onPressed;   // 👈 field declare kiya
