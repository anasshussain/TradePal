...
import '/viewmodels/countinue_booking_model.dart';
export '/viewmodels/countinue_booking_model.dart';

class CountinueBookingWidget extends StatefulWidget {
  const CountinueBookingWidget({
    ...
    bool? loading,
    bool? disabled,
  })  : this.content = content ?? 'Continue Booking',
  ...
  @override
  State<CountinueBookingWidget> createState() => _CountinueBookingWidgetState();
}

class _CountinueBookingWidgetState extends State<CountinueBookingWidget> {
  late CountinueBookingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CountinueBookingModel());
